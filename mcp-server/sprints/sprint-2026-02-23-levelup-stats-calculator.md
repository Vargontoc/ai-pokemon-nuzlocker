...
- [] Implementar personalidad al agente. Seria una personalidad inamica, el usuario podria configurar la personalidad de la sesion. Las personalidades que podriamos implementar es [Tecnico, Amable, Cinico, Burlon, Bromista, Sensual (dentro de unos limites), Deprimido, Entusiasta]. Creo que para empezar esta bien.
